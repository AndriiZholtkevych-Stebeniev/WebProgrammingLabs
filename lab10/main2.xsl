        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    li {
                        padding: 8px 0;
                        border-bottom: 1px solid #ddd; /* Adds an underline */
                    }
                    li:last-child {
                        border-bottom: none;
                    }
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        <h2>Список співробітників відділу: Розрахунковий</h2>
                        <ul>
                            <xsl:for-each select="s">
                                <li>
                                    <span></span> <xsl:value-of select="@name"/> <xsl:text> </xsl:text><xsl:value-of select="@fam"/>
                                </li>
                            </xsl:for-each>
                        </ul>
                    </div>
